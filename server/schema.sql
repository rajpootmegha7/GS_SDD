...
-- Create user info table in DATABASE
...
ALTER TABLE IF EXISTS userInfo
    OWNER to postgres;
Create plant info table in database.

DROP TABLE IF EXISTS public.plantInfo;

CREATE TABLE public.plantInfo(
...
ALTER TABLE IF EXISTS public.plantInfo
    OWNER to postgres;


-- Insert data into plant table in database.

INSERT INTO public.plantInfo( PLANT_NAME,PLANT_TYPE,PLANT_SPACING,ZONE_LOWER,ZONE_UPPER,
